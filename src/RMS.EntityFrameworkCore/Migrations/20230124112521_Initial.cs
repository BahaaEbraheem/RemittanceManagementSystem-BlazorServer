        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppRemittances_AbpUsers_ApprovedBy",
                        column: x => x.ApprovedBy,
                        principalTable: "AbpUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AppRemittances_AbpUsers_CreatorId",
                        column: x => x.CreatorId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AppRemittances_AbpUsers_ReleasedBy",
                        column: x => x.ReleasedBy,
                        principalTable: "AbpUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AppRemittances_AppCurrencies_CurrencyId",
                        column: x => x.CurrencyId,
                        principalTable: "AppCurrencies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppRemittances_AppCustomers_ReceiverBy",
                        column: x => x.ReceiverBy,
                        principalTable: "AppCustomers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AppRemittances_AppCustomers_SenderBy",
                        column: x => x.SenderBy,
                        principalTable: "AppCustomers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppCustomers_FirstName_LastName_FatherName_MotherName",
                table: "AppCustomers",
                columns: new[] { "FirstName", "LastName", "FatherName", "MotherName" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AppRemittances_ApprovedBy",
                table: "AppRemittances",
                column: "ApprovedBy");

            migrationBuilder.CreateIndex(
                name: "IX_AppRemittances_CreatorId",
                table: "AppRemittances",
                column: "CreatorId");

            migrationBuilder.CreateIndex(
                name: "IX_AppRemittances_CurrencyId",
                table: "AppRemittances",
                column: "CurrencyId");

            migrationBuilder.CreateIndex(
                name: "IX_AppRemittances_ReceiverBy",
                table: "AppRemittances",
                column: "ReceiverBy");

            migrationBuilder.CreateIndex(
                name: "IX_AppRemittances_ReleasedBy",
                table: "AppRemittances",
                column: "ReleasedBy");

            migrationBuilder.CreateIndex(
                name: "IX_AppRemittances_SenderBy",
                table: "AppRemittances",
                column: "SenderBy");
