...
namespace RMS.Migrations
{
    ...
    [Migration("20221005101500_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RMS.Currencies.Currency", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("RMS.Customers.Customer", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("RMS.Remittances.Remittance", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("RMS.Status.RemittanceStatus", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("RMS.Remittances.Remittance", b =>
                {
                    ...
                    b.HasOne("RMS.Currencies.Currency", null)
                        .WithMany()
                        .HasForeignKey("CurrencyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RMS.Customers.Customer", null)
                        .WithMany()
                        .HasForeignKey("ReceiverBy");
            ...
            modelBuilder.Entity("RMS.Status.RemittanceStatus", b =>
                {
                    b.HasOne("RMS.Remittances.Remittance", null)
                        .WithMany("Status")
